...
Функция ПолучитьДанныеДляПечатнойФормыЗаказ(ПараметрыПечати, СсылкаНаОбъект) Экспорт
	...
	|	1 КАК Курс,
	|	_ДемоЗаказПокупателя.ДоговорКонтрагента.НомерДоговора КАК ДоговорНомер,
	|	_ДемоЗаказПокупателя.ДоговорКонтрагента.ДатаДоговора КАК ДоговорДата,
	|	_ДемоЗаказПокупателя.ДоговорКонтрагента.Наименование КАК ДоговорНаименование,
	|	_ДемоЗаказПокупателя.Основание КАК ДокументОснование
	|	_ДемоЗаказПокупателя.ДокументСделки КАК ДокументСделки
	|ИЗ
