...
Процедура ЛицензионноеСоглашениеСсылкаНажатие(Элемент)
	...
	ОбщегоНазначенияКлиент.ОткрытьНавигационнуюСсылку("http://umi.ru/servicelicense/");
...
Процедура ОткрытьЦены(Элемент)
	...
	ОбщегоНазначенияКлиент.ОткрытьНавигационнуюСсылку("http://umi.ru/price/");
...
Процедура ОткрытьСозданныйСайт(ДанныеСозданияСайтаСтруктура)
	...
	ОбщегоНазначенияКлиент.ОткрытьНавигационнуюСсылку(СтрЗаменить(ДанныеСозданияСайтаСтруктура.СсылкаАдминЗоны, "/adminzone/","/adminzone/main/"));
	ОбщегоНазначенияКлиент.ОткрытьНавигационнуюСсылку("http://" +ДанныеСозданияСайтаСтруктура.АдресСайта);
