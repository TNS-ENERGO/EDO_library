...
Процедура ПриОткрытии(Отказ)
	...
	ПроверитьСостояниеСервиса(Ложь);
...
&НаКлиенте
Процедура ПроверитьСостояниеСервиса(Ожидать = Истина)
	...
	Если Константа_ИспользоватьСервисРаботаСНоменклатурой Тогда 
		...
		РаботаСНоменклатуройКлиент.ПроверитьСостояниеСервиса(ПроверитьСостояниеСервисаЗавершение, Ожидать, ЭтотОбъект, ИдентификаторЗадания);
	Иначе
