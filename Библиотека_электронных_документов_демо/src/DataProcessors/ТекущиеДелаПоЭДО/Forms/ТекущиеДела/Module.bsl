...
Процедура СоздатьОтборПоРазделу(Знач Раздел, Знач НастройкиОтображения, ГруппаОтбора)
	...
	ИначеЕсли Раздел = "ТребуетсяПригласить" Тогда
		...
		Значение = Новый Массив;
		Значение.Добавить(ПредопределенноеЗначение("Перечисление.СтатусыУчастниковОбменаЭД.ТребуетсяПригласить"));
		Значение.Добавить(ПредопределенноеЗначение("Перечисление.СтатусыУчастниковОбменаЭД.Ошибка"));
	...
	ИначеЕсли Раздел = "ЖдемСогласия" Тогда 
		...
		Значение = Новый Массив;
		Значение.Добавить(ПредопределенноеЗначение("Перечисление.СтатусыУчастниковОбменаЭД.ОжидаемСогласия"));
...
Функция ТекстЗапросаКоличестваЭлементовПоРазделуБезОтбора(Знач Раздел) 
	...
	ИначеЕсли Раздел = "Сформировать" Тогда
		...
		|		И НЕ СостоянияЭД.СсылкаНаОбъект ССЫЛКА Справочник.СоглашенияОбИспользованииЭД) КАК ВложенныйЗапрос";
	...
	ИначеЕсли Раздел = "ТребуетсяПригласить" Тогда
		...
		|		1 КАК _Счетчик
		|	ИЗ
		|		Справочник.СоглашенияОбИспользованииЭД КАК ОсновнаяТаблица
		|	ГДЕ
		|		НЕ ОсновнаяТаблица.ПометкаУдаления
		|		И ОсновнаяТаблица.СтатусПодключения В (ЗНАЧЕНИЕ(Перечисление.СтатусыУчастниковОбменаЭД.ТребуетсяПригласить), ЗНАЧЕНИЕ(Перечисление.СтатусыУчастниковОбменаЭД.Ошибка))) КАК ВложенныйЗапрос";
	...
	ИначеЕсли Раздел = "ЖдемСогласия" Тогда
		...
		|	ГДЕ
		|		НЕ ОсновнаяТаблица.ПометкаУдаления
		|		И ОсновнаяТаблица.СтатусПодключения = ЗНАЧЕНИЕ(Перечисление.СтатусыУчастниковОбменаЭД.ОжидаемСогласия)) КАК ВложенныйЗапрос";
	...
	ИначеЕсли Раздел = "ТребуетсяСогласие" Тогда
		...
		|	ГДЕ
		|		НЕ ОсновнаяТаблица.ПометкаУдаления
		|		И ОсновнаяТаблица.СтатусПодключения = ЗНАЧЕНИЕ(Перечисление.СтатусыУчастниковОбменаЭД.ТребуетсяСогласие)) КАК ВложенныйЗапрос";
