...
Процедура СформироватьОтчет(ПараметрыОтчета, АдресХранилища) Экспорт
	...
	Если ДанныеОтчета.СостояниеДосье = "ПолученыДанные" Тогда
		...
		Если ЭтоЮридическоеЛицо Тогда
			ПодготовитьДанныеБухгалтерскойОтчетности(ИнформацияОСвязях, ПериодыОтчетности);
	...
	Если ДанныеОтчета.СостояниеПроверки = "ПолученыДанные" Тогда
		...
		СформироватьРезультатПроверкиКонтролирующимиОрганами(ИнформацияОПроверках, ПараметрыОтчета.ИНН, ДанныеОтчета, ДанныеПроверки);
...
Процедура ПодготовитьДанныеБухгалтерскойОтчетности(ИнформацияОСвязях, СтруктураГодов)
