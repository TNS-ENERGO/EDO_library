...
Процедура ПриПолученииОписанияВариантаНастройки(ОписаниеВарианта, ИдентификаторНастройки, ПараметрыКонтекста) Экспорт
	...
	ОписаниеВарианта.ЗаголовокПомощникаСозданияОбмена =
		НСтр("ru = 'Синхронизация данных с ""1С:Управление торговлей, ред. 10.3"" (настройка)'");
...
Функция КраткаяИнформацияПоОбмену(ИдентификаторНастройки)
	...
	|Из приложения ""Управление торговлей"" в приложение ""Клиент ЭДО"" переносятся документы и все необходимые справочники 
...
Функция ПодробнаяИнформацияПоОбмену(ИдентификаторНастройки)
	...
	ПутьКИнформацииПоОбмену = "ПланОбмена.ОбменУправлениеТорговлей103КлиентЭДО.Форма.ПодробнаяИнформация";
