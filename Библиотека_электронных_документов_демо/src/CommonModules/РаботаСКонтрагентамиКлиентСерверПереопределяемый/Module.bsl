...
Процедура ОпределитьВидДокумента(Форма, Результат) Экспорт
	...
	// КлиентЭДО начало
	РаботаСКонтрагентамиКлиентСерверКЭДО.ОпределитьВидДокумента(Форма, Результат);
	// КлиентЭДО конец
...
Процедура ПолучитьСчетФактуру(Форма, СчетФактура) Экспорт
	...
	// КлиентЭДО начало
	РаботаСКонтрагентамиКлиентСерверКЭДО.ПолучитьСчетФактуру(Форма, СчетФактура);
	// КлиентЭДО конец
...
Процедура ОтобразитьРезультатПроверкиКонтрагентаВСправочнике(Форма, ПредставлениеРезультатаПроверки) Экспорт
	...
	// КлиентЭДО начало
	РаботаСКонтрагентамиКлиентСерверКЭДО.ОтобразитьРезультатПроверкиКонтрагентаВСправочнике(Форма, ПредставлениеРезультатаПроверки);
	// КлиентЭДО конец
...
Процедура ПриОпределенииОбъектаИСсылкиПоФорме(Форма, Результат) Экспорт
	...
	// КлиентЭДО начало
	РаботаСКонтрагентамиКлиентСерверКЭДО.ПриОпределенииОбъектаИСсылкиПоФорме(Форма, Результат);
	// КлиентЭДО конец
