...
Процедура ОткрытьФормуВыбораПользователей(ВладелецФормы, ТекущийПользователь) Экспорт
	...
	// КлиентЭДО начало
	ОбменСКонтрагентамиКЭДОКлиент.ОткрытьФормуВыбораПользователей(ВладелецФормы, ТекущийПользователь);
	// КлиентЭДО конец
...
Процедура ОткрытьФормуПодбораТоваров(ИдентификаторФормы, ОбработкаПродолжения) Экспорт
	...
	// КлиентЭДО начало
	ОбменСКонтрагентамиКЭДОКлиент.ОткрытьФормуПодбораТоваров(ИдентификаторФормы, ОбработкаПродолжения);
	// КлиентЭДО конец
...
Процедура СопоставлятьНоменклатуруПередЗаполнениемДокумента(СопоставлятьНоменклатуру) Экспорт
	...
	// КлиентЭДО начало
	ОбменСКонтрагентамиКЭДОКлиент.СопоставлятьНоменклатуруПередЗаполнениемДокумента(СопоставлятьНоменклатуру);
	// КлиентЭДО конец
...
Процедура ОткрытьЭлементНоменклатурыПоставщика(Идентификатор) Экспорт
	...
	// КлиентЭДО начало
	ОбменСКонтрагентамиКЭДОКлиент.ОткрытьЭлементНоменклатурыПоставщика(Идентификатор);
	// КлиентЭДО конец
...
Процедура ОткрытьФормуСопоставленияНоменклатуры(Элемент, Параметры, СтандартнаяОбработка = Неопределено) Экспорт
	...
	// КлиентЭДО начало
	ОбменСКонтрагентамиКЭДОКлиент.ОткрытьФормуСопоставленияНоменклатуры(Элемент, Параметры, СтандартнаяОбработка);
	// КлиентЭДО конец
