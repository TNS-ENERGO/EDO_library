...
Процедура ПараметрыРаботыКлиентаПриЗапуске(Параметры) Экспорт
	...
	ПоказатьОкноНачалоРаботыСПрограммой = НЕ ЗначениеЗаполнено(Константы._ДемоДатаПервогоВходаВСистему.Получить());
...
// См. процедуру ОбщегоНазначенияПереопределяемый.ПриДобавленииПереименованийОбъектовМетаданных().
//
...
// Обработчик обновления БЭД 1.3.6.18 (демонстрационная база).
// Включает демонстрационные функциональные опции для отображения разделов подсистем.
//
Процедура ВключитьДемонстрационныеФункциональныеОпции() Экспорт
	
	Если Константы._ДемоПоказыватьПодсистемуОбменСКонтрагентами.Получить() = Ложь
		И Константы._ДемоПоказыватьПодсистемуОбменСБанками.Получить() = Ложь
		И Константы._ДемоПоказыватьПодсистемуОбменССайтами.Получить() = Ложь
		И Константы._ДемоПоказыватьПодсистему1CБизнесСеть.Получить() = Ложь Тогда
		
		Константы._ДемоПоказыватьПодсистемуОбменСКонтрагентами.Установить(Истина);
		Константы._ДемоПоказыватьПодсистемуОбменСБанками.Установить(Истина);
		Константы._ДемоПоказыватьПодсистемуОбменССайтами.Установить(Истина);
		Константы._ДемоПоказыватьПодсистему1CБизнесСеть.Установить(Истина);
		
	КонецЕсли;
	
КонецПроцедуры

// Обработчик обновления БЭД 1.3.9.6 (демонстрационная база).
...
Процедура ОбновитьПредопределенныеВидыКонтактнойИнформации() Экспорт
	...
	// Справочник "_ДемоСклады"
	ВидКонтактнойИнформацииОбъект = Справочники.ВидыКонтактнойИнформации.Справочник_ДемоСклады.ПолучитьОбъект();
	...
	ПараметрыВида.Вид = Справочники.ВидыКонтактнойИнформации._ДемоАдресСклада;
