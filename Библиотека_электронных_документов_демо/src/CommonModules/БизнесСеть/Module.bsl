...
Процедура ИзменитьРегламентноеЗадание(ИмяЗадания, ИмяПараметра, ЗначениеПараметра) Экспорт
	...
	Если МассивРегламентныхЗаданий.Количество() <> 1 Тогда
		Возврат;
	КонецЕсли;
