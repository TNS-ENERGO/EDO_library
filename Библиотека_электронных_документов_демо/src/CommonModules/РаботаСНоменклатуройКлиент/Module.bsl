...
Процедура ПроверитьСостояниеСервиса(ОповещениеОЗавершении, Ожидать, Форма, ИдентификаторЗадания = Неопределено) Экспорт 
	
	ДлительнаяОперация = РаботаСНоменклатуройСлужебныйВызовСервера.ПроверитьСостояниеСервисаВФоне(Ожидать, Форма.УникальныйИдентификатор, ИдентификаторЗадания);
