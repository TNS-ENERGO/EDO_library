...
Процедура ЗаполнитьРегистрационныеДанныеОрганизации(Организация, ДанныеОрганизации) Экспорт
	...
	// КлиентЭДО начало
	ЭлектронноеВзаимодействиеКЭДО.ЗаполнитьРегистрационныеДанныеОрганизации(Организация, ДанныеОрганизации);
	// КлиентЭДО конец
...
Процедура ИзменитьСвойстваЭлементовФормы(Форма, СтруктураПараметров) Экспорт
	...
	_ДемоЭлектронноеВзаимодействие.ИзменитьСвойстваЭлементовФормы(Форма, СтруктураПараметров);
	// _Демо конец примера
...
Процедура ПолучитьСоответствиеФункциональныхОпций(СоответствиеФО) Экспорт
	...
	// _Демо начало примера
	_ДемоЭлектронноеВзаимодействие.ПолучитьСоответствиеФункциональныхОпций(СоответствиеФО);
	// _Демо конец примера
...
Процедура ПолучитьСоответствиеСправочников(СоответствиеСправочников) Экспорт
	...
	// КлиентЭДО начало
	ЭлектронноеВзаимодействиеКЭДО.ПолучитьСоответствиеСправочников(СоответствиеСправочников);
	// КлиентЭДО конец
	
	// _Демо начало примера
	_ДемоЭлектронноеВзаимодействие.ПолучитьСоответствиеСправочников(СоответствиеСправочников);
	// _Демо конец примера
...
Процедура ПолучитьСоответствиеНаименованийОбъектовМДИРеквизитов(СоответствиеРеквизитовОбъекта) Экспорт
	...
	// КлиентЭДО начало
	ЭлектронноеВзаимодействиеКЭДО.ПолучитьСоответствиеНаименованийОбъектовМДИРеквизитов(СоответствиеРеквизитовОбъекта);
	// КлиентЭДО конец
	
	// _Демо начало примера
	_ДемоЭлектронноеВзаимодействие.ПолучитьСоответствиеНаименованийОбъектовМДИРеквизитов(СоответствиеРеквизитовОбъекта);
	// _Демо конец примера
...
Процедура СоответствиеКодовРеквизитовИПредставлений(СоответствиеВозврата) Экспорт
	...
	// _Демо начало примера
	_ДемоЭлектронноеВзаимодействие.СоответствиеКодовРеквизитовИПредставлений(СоответствиеВозврата);
	// _Демо конец примера
...
Процедура ИзменитьСообщениеОбОшибке(КодОшибки, ТекстОшибки) Экспорт
	...
	// _Демо начало примера
	_ДемоЭлектронноеВзаимодействие.ИзменитьСообщениеОбОшибке(КодОшибки, ТекстОшибки);
	// _Демо конец примера
...
Процедура НайтиСсылкуНаОбъект(ТипОбъекта, Результат, ИдОбъекта = "", ДополнительныеРеквизиты = Неопределено, ИДЭД = Неопределено) Экспорт
	...
	// _Демо начало примера
	_ДемоЭлектронноеВзаимодействие.НайтиСсылкуНаОбъект(ТипОбъекта, Результат, ИдОбъекта, ДополнительныеРеквизиты, ИДЭД);
	// _Демо конец примера
...
Процедура ПолучитьПечатныйНомерДокумента(СсылкаНаОбъект, Результат) Экспорт
	...
	// КлиентЭДО начало
	ЭлектронноеВзаимодействиеКЭДО.ПолучитьПечатныйНомерДокумента(СсылкаНаОбъект, Результат);
	// КлиентЭДО конец
...
Процедура ПроверитьГотовностьИсточников(ДокументыМассив) Экспорт
	...
	// КлиентЭДО начало
	ЭлектронноеВзаимодействиеКЭДО.ПроверитьГотовностьИсточников(ДокументыМассив);
	// КлиентЭДО конец
	
	// _Демо начало примера
	_ДемоЭлектронноеВзаимодействие.ПроверитьГотовностьИсточников(ДокументыМассив);
	// _Демо конец примера
...
Процедура ПолучитьДанныеЮрФизЛица(ЮрФизЛицо, Сведения) Экспорт
	...
	ЭлектронноеВзаимодействиеКЭДО.ПолучитьДанныеЮрФизЛица(ЮрФизЛицо, Сведения);
...
Процедура ОписаниеОрганизации(СведенияОрганизации, Результат, Список = "", СПрефиксом = Истина) Экспорт
	...
	// КлиентЭДО начало
	ЭлектронноеВзаимодействиеКЭДО.ОписаниеОрганизации(СведенияОрганизации, Результат, Список, СПрефиксом);
	// КлиентЭДО конец
...
Процедура ЕстьПравоОткрытияЖурналаРегистрации(Результат) Экспорт
	...
	// КлиентЭДО начало
	ЭлектронноеВзаимодействиеКЭДО.ЕстьПравоОткрытияЖурналаРегистрации(Результат);
	// КлиентЭДО конец
...
Процедура ПередЗаписьюВладельцаЭлектронногоДокумента(Объект, ИзменилисьКлючевыеРеквизиты, Знач СостояниеЭлектронногоДокумента, ПодлежитОбменуЭД, Отказ) Экспорт
	...
	// КлиентЭДО начало
	ЭлектронноеВзаимодействиеКЭДО.ПередЗаписьюВладельцаЭлектронногоДокумента(
		Объект, ИзменилисьКлючевыеРеквизиты, СостояниеЭлектронногоДокумента, ПодлежитОбменуЭД, Отказ);
	// КлиентЭДО конец
	
	// _Демо начало примера
	_ДемоОбменСБанкамиВызовСервера.ПередЗаписьюВладельцаЭлектронногоДокумента(
		Объект, ИзменилисьКлючевыеРеквизиты, СостояниеЭлектронногоДокумента, ПодлежитОбменуЭД, Отказ);
	// _Демо конец примера
