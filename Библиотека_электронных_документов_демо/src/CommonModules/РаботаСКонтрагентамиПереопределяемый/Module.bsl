...
Процедура СформироватьОписаниеДокументовСоСчетомФактуройВПодвале(Форма, Описание) Экспорт
	...
	// КлиентЭДО начало
	РаботаСКонтрагентамиКЭДО.СформироватьОписаниеДокументовСоСчетомФактуройВПодвале(Форма, Описание);
	// КлиентЭДО конец
...
Процедура СформироватьОписаниеДокументовСКонтрагентомВШапке(Форма, Описание) Экспорт
	...
	// КлиентЭДО начало
	РаботаСКонтрагентамиКЭДО.СформироватьОписаниеДокументовСКонтрагентомВШапке(Форма, Описание);
	// КлиентЭДО конец
...
Процедура СформироватьОписаниеСчетовФактур(Форма, Описание) Экспорт
	...
	// КлиентЭДО начало
	РаботаСКонтрагентамиКЭДО.СформироватьОписаниеСчетовФактур(Форма, Описание);
	// КлиентЭДО конец
...
Процедура ПолучитьИменаРеквизитовКонтрагентовВСчетеФактуре(Тип, ИменаРеквизитов) Экспорт
	...
	// КлиентЭДО начало
	РаботаСКонтрагентамиКЭДО.ПолучитьИменаРеквизитовКонтрагентовВСчетеФактуре(Тип, ИменаРеквизитов);
	// КлиентЭДО конец
...
Процедура ОпределитьДатуВДокументе(ДокументОбъект, Дата) Экспорт
	...
	// КлиентЭДО начало
	РаботаСКонтрагентамиКЭДО.ОпределитьДатуВДокументе(ДокументОбъект, Дата);
	// КлиентЭДО конец
...
Процедура ОпределитьДатуВСчетеФактуре(СчетФактураОбъект, Дата) Экспорт
	...
	// КлиентЭДО начало
	РаботаСКонтрагентамиКЭДО.ОпределитьДатуВСчетеФактуре(СчетФактураОбъект, Дата);
	// КлиентЭДО конец
...
Процедура ПриОпределенииСвойствСправочниковКонтрагентов(СвойстваСправочников) Экспорт
	...
	// КлиентЭДО начало
	РаботаСКонтрагентамиКЭДО.ПриОпределенииСвойствСправочниковКонтрагентов(СвойстваСправочников);
	// КлиентЭДО конец
...
Процедура ПриОпределенииВидаКонтрагента(СтандартнаяОбработка, ЭтоЮрЛицо, ДанныеКонтрагента) Экспорт
	...
	// КлиентЭДО начало
	РаботаСКонтрагентамиКЭДО.ПриОпределенииВидаКонтрагента(СтандартнаяОбработка, ЭтоЮрЛицо, ДанныеКонтрагента);
	// КлиентЭДО конец
...
Процедура ДополнитьРеквизитыФормыКонтрагент(Форма, НовыеРеквизиты) Экспорт
	...
	// КлиентЭДО начало
	РаботаСКонтрагентамиКЭДО.ДополнитьРеквизитыФормыКонтрагент(Форма, НовыеРеквизиты);
	// КлиентЭДО конец
...
Процедура ЗаполнитьИдентификаторКонфигурации(ИдентификаторКонфигурации) Экспорт
	...
	// КлиентЭДО начало
	КлиентЭДО.ПриОпределенииИмениПрограммы(ИдентификаторКонфигурации);
	// КлиентЭДО конец
