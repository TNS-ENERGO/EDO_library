...
Процедура ПриОпределенииДополнительныхНастроекЯндексКассы(ДополнительныеНастройки) Экспорт
	...
	_ДемоИнтеграцияСЯндексКассой.ПриОпределенииДополнительныхНастроекЯндексКассы(ДополнительныеНастройки);
	// _Демо конец примера
...
Процедура ПриСозданииФормыНастроекЯндексКассы(Форма, Группа, Префикс, ДополнительныеНастройки) Экспорт
	...
	// _Демо начало примера
	_ДемоИнтеграцияСЯндексКассой.ПриСозданииФормыНастроекЯндексКассы(Форма, Группа, Префикс, ДополнительныеНастройки);
	// _Демо конец примера
...
Процедура ПередНачаломРедактированияДополнительныхНастроекЯндексКассы(Контекст, Отказ = Ложь) Экспорт
	...
	// _Демо начало примера
	_ДемоИнтеграцияСЯндексКассой.ПередНачаломРедактированияДополнительныхНастроекЯндексКассы(Контекст, Отказ);
	// _Демо конец примера
...
Процедура ПередОкончаниемРедактированияДополнительныхНастроекЯндексКассы(Контекст, Отказ = Ложь) Экспорт
	...
	// _Демо начало примера
	_ДемоИнтеграцияСЯндексКассой.ПередОкончаниемРедактированияДополнительныхНастроекЯндексКассы(Контекст, Отказ);
	// _Демо конец примера
...
Процедура ПриОпределенииОснованийПлатежа(ОснованияПлатежа) Экспорт
	...
	// _Демо начало примера
	_ДемоИнтеграцияСЯндексКассой.ПриОпределенииОснованийПлатежа(ОснованияПлатежа);
	// _Демо конец примера
...
Процедура ПриПроверкеЗаполненияОснованияПлатежа(Знач ОснованиеПлатежа, Отказ) Экспорт
	...
	// _Демо начало примера
	_ДемоИнтеграцияСЯндексКассой.ПриПроверкеЗаполненияОснованияПлатежа(ОснованиеПлатежа, Отказ);
	// _Демо конец примера
...
Процедура ЗаполнитьРеквизитыОрганизации(Знач Организация, Реквизиты) Экспорт
	...
	// _Демо начало примера
	_ДемоИнтеграцияСЯндексКассой.ЗаполнитьРеквизитыОрганизации(Организация, Реквизиты);
	// _Демо конец примера
...
Процедура ЗаполнитьДанныеОснованияПлатежа(Знач ОснованиеПлатежа, ДанныеОснованияПлатежа) Экспорт
	...
	// _Демо начало примера
	_ДемоИнтеграцияСЯндексКассой.ЗаполнитьДанныеОснованияПлатежа(ОснованиеПлатежа, ДанныеОснованияПлатежа);
	// _Демо конец примера
...
Процедура ПриЗагрузкеОперацийПоЯндексКассе(Знач Операции, Результат, Отказ) Экспорт
	...
	// _Демо начало примера
	_ДемоИнтеграцияСЯндексКассой.ПриЗагрузкеОперацийПоЯндексКассе(Операции, Результат, Отказ);
	// _Демо конец примера
...
Процедура ПредопределенныеШаблоныСообщений(Шаблоны) Экспорт 
	...
	// _Демо начало примера
	_ДемоИнтеграцияСЯндексКассой.ПредопределенныеШаблоныСообщений(Шаблоны);
	// _Демо конец примера
